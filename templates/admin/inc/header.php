...
<div class="wrapper">
	<div class="sidebar" data-background-color="white" data-active-color="danger">
    	<div class="sidebar-wrapper">
            <div class="logo">
                <a href="/admin" class="simple-text">ADMIN</a>
            </div>
            ...
            <ul class="nav">
            	...
            	<li <?php if(strstr($url, "admin/loaisanpham")){ echo 'class="active"'; }  ?> >
					<?php
						$query1 = "SELECT COUNT(*) AS total1 FROM loaisanpham";
                    ...
                    <a href="/admin/loaisanpham">
                        <i class="ti-map"></i>
                        <p>QUẢN LÝ LOẠI SÁCH(<?php echo '<span style="color:red">'.$total1.'</span>'; ?>)</p>
                    </a>
                </li>	
            	<li <?php if(strstr($url, "admin/sanpham")){ echo 'class="active"'; }  ?> >
					<?php
						$query2 = "SELECT COUNT(*) AS total2 FROM sanpham";
                    ...
                    <a href="/admin/sanpham">
                        <i class="ti-book"></i>
                        <p>QUẢN LÝ SÁCH (<?php echo '<span style="color:red">'.$total2.'</span>'; ?>)</p>
                    </a>
                </li>
                <li <?php if(strstr($url, "admin/khachhang")){ echo 'class="active"'; }  ?> >
					<?php
						$query3 = "SELECT COUNT(*) AS total3 FROM khachhang";
                    ...
                    <a href="/admin/khachhang">
                        ...
                        <p>QUẢN LÝ KHÁCH HÀNG (<?php echo '<span style="color:red">'.$total3.'</span>'; ?>)</p>
                    </a>
                </li>
                <li <?php if(strstr($url, "admin/donhang")){ echo 'class="active"'; }  ?> >
					<?php
						//$query4 = "SELECT   COUNT(*)  AS   total4  FROM chitietdonhang";
                    ...
                    <a href="/admin/donhang">
                        ...
                        <p>QUẢN LÝ ĐƠN HÀNG <?php //echo '<span style="color:red">'.$total4.'</span>'; ?></p>
                    </a>
                </li>
				<li <?php if(strstr($url, "admin/user")){ echo 'class="active"'; }  ?> >
					<?php
						$query6 = "SELECT COUNT(*) AS total6 FROM user";
                    ...
                    <a href="/admin/user">
                        <i class="ti-user"></i>
                        <p>QUẢN LÝ USER (<?php echo '<span style="color:red">'.$total6.'</span>'; ?>)</p>
                    </a>
                </li>
				<li <?php if(strstr($url, "admin/lienhe")){ echo 'class="active"'; }  ?> >
					<?php
						$query6 = "SELECT COUNT(*) AS total6 FROM lienhe";
						$result6 = $mysqli->query($query6);
						$ar6 = mysqli_fetch_assoc($result6);
						$total6 = $ar6['total6'];
					?>
                    <a href="/admin/lienhe">
                        <i class="ti-help"></i>
                        <p>QUẢN LÝ LIÊN HỆ (<?php  echo '<span style="color:red">'.$total6.'</span>'; ?>)</p>
                    </a>
                </li>
				<li <?php if(strstr($url, "admin/slide")){ echo 'class="active"'; }  ?> >
					<?php
						$query6 = "SELECT COUNT(*) AS total6 FROM slide";
						$result6 = $mysqli->query($query6);
						$ar6 = mysqli_fetch_assoc($result6);
						$total6 = $ar6['total6'];
					?>
                    <a href="/admin/slide">
                        <i class="ti-panel"></i>
                        <p>QUẢN LÝ SLIDE (<?php  echo '<span style="color:red">'.$total6.'</span>'; ?>)</p>
                    </a>
                </li>
            </ul>
    	</div>
