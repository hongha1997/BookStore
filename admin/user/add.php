...
<script type="text/javascript">
	document.title='Add User | Bookstore';
</script>
                            ...
                            <div class="content">
								<?php
									if(isset($_POST['submit'])){
										...
										$query = "SELECT COUNT(NameUser) AS total FROM user WHERE NameUser = '{$username}' ";
										$result = $mysqli->query($query);									
										$ar = mysqli_fetch_assoc($result);
										if($ar['total'] == 0){
											$query2 = "INSERT INTO user(NameUser, MatKhau, FullName, PhanCap) VALUES('{$username}', '{$password}', '{$hoten}','{$chucvu}')";
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Name User</label><?php if(isset($msg2)){ echo '<h4 style="color:red" >'.$msg2.'</h4>'; } ?>
